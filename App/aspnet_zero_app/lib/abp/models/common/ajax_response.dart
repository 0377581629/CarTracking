...
class SimpleAjaxResponse {
  ...
  factory SimpleAjaxResponse.fromJson(Map<String, dynamic> json) =>
      _$SimpleAjaxResponseFromJson(json);

  Map<String, dynamic> toJson() => _$SimpleAjaxResponseToJson(this);
}
