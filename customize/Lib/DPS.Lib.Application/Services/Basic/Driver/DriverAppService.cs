...
namespace DPS.Lib.Application.Services.Basic.Driver
{
    [AbpAuthorize(LibPermissions.Driver)]
    public class DriverAppService: ZeroAppServiceBase,IDriverAppService
    {
        private readonly IRepository<Core.Basic.Driver.Driver> _driverRepository;

        public DriverAppService(IRepository<Core.Basic.Driver.Driver> driverRepository)
        {
        ...
        {
            var obj = ObjectMapper.Map<Core.Basic.Driver.Driver>(input);
